...
to install do ```pkg install firefox```  I would also recommemd Chromium if it wasent for it being buggy to run and websites not loading unless you lower your security level and you having to make your browser more prone to crashing if one tab crashes just to get sites to load  
